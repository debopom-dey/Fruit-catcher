class Game{
    ...
    play(){
                ...
                display_position+=20
                textSize(15)
                text(allPlayers[plr].name+": "+allPlayers.player1.score,120,display_position)
                text(allPlayers[plr].name+": "+allPlayers.player2.score,120,180)
                     ...
                     if(index === player.index){
                         ...
                         this.playername.position(x+250,y+80)
                         this.playername.style('color','red')
